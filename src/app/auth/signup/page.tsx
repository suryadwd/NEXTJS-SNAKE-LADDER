  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white">
      ...
      <div className="px-[7%] py-[1%] flex flex-col items-center justify-center  border border-white rounded-3xl">
        ...
        <Button onClick={handelSubmit} className="px-8 py-1 bg-blue-400 hover:bg-green-400 rounded-3xl mb-5">{loading ? "Loading..." : "Signup"}</Button>
        <Link href="/auth/login"> {/* Add Link component to navigate */}
